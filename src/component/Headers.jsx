...
const Headers = () => {
  ...
  return (
    <header>
<Headermob mobileHeaderOn = {mobileHeaderOn} setMobileHeaderOn = {setMobileHeaderOn}/>
        ...
        <nav>
            ...
            <ul className='header' id='nav-menu'>
                ...
                <div className='header-pages-details'>
                  ...
                  <li><Link to="/details/:id">Checkout</Link></li>
                  <li><Link to="/details/:id">Blog Details</Link></li>
                  </ul>
                </div>
                </li>
                <li>
            ...
            <ul className='logres'>
                ...
                <div class="mobile-menu" id="menu">
                    <i class="fa-solid fa-bars" id="mobile-menu" onClick={mobileHeaderOpen}></i>
                </div>
        </nav>        
        </div>
